...
@Component({
	selector: 'app-campaignlistnotif',
	templateUrl: './campaignlistnotif.component.html',
	styleUrls: ['./campaignlistnotif.component.scss']
})
export class CampaignlistnotifComponent implements OnInit {
