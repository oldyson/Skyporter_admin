...
@Component({
	selector: 'app-ngcheckinfamilydetail',
	templateUrl: './ngcheckinfamilydetail.component.html',
	styleUrls: ['./ngcheckinfamilydetail.component.scss']
})
export class NgcheckinfamilydetailComponent implements OnInit {
